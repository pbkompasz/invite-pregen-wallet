...
const Giveaway = () => {
  ...
  const [isWarpcastAuthenticated, setIsWarpcastAuthenticated] = useState(false);
  ...
  return (
    <>
      <AuthKitProvider config={config}>
        <WarpcastAuth callback={setIsWarpcastAuthenticated}></WarpcastAuth>
        ...
        {scenario === "claim" && isWarpcastAuthenticated && <Claim />}
      </AuthKitProvider>
    </>
  );
};
